...
INSERT INTO `coupon_product` (`id_coupon`, `product_id`, `code_coupon`, `min_purchase`, `homeDeliv`, `dineIn`, `takeaway`, `discount_coupon`, `start_expired`, `end_expired`, `status_promo`, `create_at`, `delete_at`, `update_at`) VALUES
	...
	(2, 1, 'Anya Sayang', 5, 'OFF', 'OFF', 'OFF', 80, '2021-01-27', '2021-01-29', 'ON', '2021-01-05 03:50:58', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
INSERT INTO `history_product` (`id_history`, `user_id`, `payment_method`, `invoice_payment`, `sub_total`, `status_history`, `create_at`, `delete_at`) VALUES
	(1, 4, 'ATM', 'zVueZnOH3JmJdUMSEMXYoeyW8UBXciUy', 516000, 'OFF', '2020-12-30 09:20:28', '0000-00-00 00:00:00'),
	(2, 4, 'ATM', 'IuQaG2BHPnSENgnknC8Pkwjx0V0YuuQg', 10000, 'OFF', '2020-12-30 09:20:28', '0000-00-00 00:00:00'),
	(3, 4, 'ATM', 'fmXgcfI5jSXANT07ly3NVW8g3m5MqV3P', 185795, 'OFF', '2020-12-30 09:20:28', '0000-00-00 00:00:00'),
	(4, 5, 'ATM', 'YsKKRz4b0Ruz3ZegKTx4dUawGwf5X92G', 191493, 'OFF', '2020-12-30 09:20:28', '0000-00-00 00:00:00'),
	(5, 4, 'ATM', 'jyil5bQY5fP1kiehnushTpD0A2M85kbm', 256675, 'OFF', '2020-12-30 09:20:28', '0000-00-00 00:00:00'),
	(6, 1, 'ATM', 'ASDQWE1231SA', 60000, 'ON', '2020-12-30 09:20:28', '0000-00-00 00:00:00'),
	(7, 4, 'ATM', 'eGst3PCldF9imTtf3E6FaS75WGsX9BIj', 448150, 'OFF', '2020-12-30 09:20:28', '0000-00-00 00:00:00');
...
INSERT INTO `main_product` (`id_product`, `name_product`, `image_product`, `price_product`, `desc_product`, `qty_product`, `category_id`, `homeDeliv`, `dineIn`, `takeaway`, `status_product`, `time_start`, `time_end`, `code_discount`, `create_at`, `update_at`, `delete_at`) VALUES
	...
	(3, 'Sushi Panggang', '2020-12-30T03-34-09.836Zvladi-braun-EersVVP_xPQ-unsplash.jpg', 40000, 'Sushi Dari Malang yang dijamin enak banget uyyy hahaha', 50, 3, 'ON', 'ON', 'OFF', 'ON', '7 am', '9 pm', '', '2020-12-30 03:33:23', '2020-12-30 03:34:10', '0000-00-00 00:00:00'),
	(4, 'Test Doang', '2021-01-05T09-03-53.931ZRGB.-Abu-131-126-125-Biru-21-10-162-Merah-224-6-37.jpg', 15000, 'Soto Lomongan dengan bumbu Merica', 20, 3, 'ON', 'ON', 'OFF', 'ON', '9am', '9pm', '', '2021-01-05 09:03:53', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
	(5, 'Test Doang Lagi', '2021-01-05T09-08-40.231ZRGB.-Abu-131-126-125-Biru-21-10-162-Merah-224-6-37.jpg', 15000, 'Soto Lomongan dengan bumbu Merica', 20, 3, 'ON', 'ON', 'OFF', 'ON', '9am', '9pm', '', '2021-01-05 09:08:40', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
	(6, 'Test Doang Lagi LAGI', '2021-01-06T03-07-15.476Z008.jpg', 15000, 'Soto Lomongan dengan bumbu Merica', 20, 3, 'ON', 'ON', 'OFF', 'ON', '9am', '9pm', '', '2021-01-06 03:07:15', '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
	(7, 'Test Doang Lagi LAGI FDAN', '2021-01-06T03-08-18.566Z008.jpg', 15000, 'Soto Lomongan dengan bumbu Merica', 20, 3, 'ON', 'ON', 'OFF', 'ON', '9am', '9pm', '', '2021-01-06 03:08:18', '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
INSERT INTO `size_typeproduct` (`id_size`, `id_Product`, `type`, `size_L`, `size_R`, `size_XL`, `size_200`, `size_350`, `size_400`, `status_product`) VALUES
	...
	(4, 3, 'Product', 'OFF', 'OFF', 'OFF', 'ON', 'ON', 'OFF', 'ON'),
	(5, 1, 'Promo', 'ON', 'ON', 'OFF', 'OFF', 'OFF', 'OFF', 'ON'),
	(6, 4, 'Product', 'ON', 'OFF', 'OFF', 'ON', 'OFF', 'OFF', 'ON'),
	(7, 5, 'Product', 'ON', 'OFF', 'OFF', 'ON', 'OFF', 'OFF', 'ON'),
	(8, 6, 'Product', 'ON', 'OFF', 'OFF', 'ON', 'OFF', 'OFF', 'ON'),
	(9, 7, 'Product', 'ON', 'OFF', 'OFF', 'ON', 'OFF', 'OFF', 'ON');
...
-- Dumping data for table anya_coffee.user: ~6 rows (approximately)
...
INSERT INTO `user` (`id_user`, `username`, `email_user`, `password`, `first_name`, `last_name`, `image_user`, `date_birth`, `phone_number`, `address_user`, `token_user`, `gender`, `roles`, `status`, `create_at`, `update_at`) VALUES
	...
	(32, 'Mr Bagus', 'bagustri15@gmail.com', '$2b$10$5VaGtrSOAFigP1xHotZXgewMP3lvJkEujjBVYDPgUdRV38DSFBjM6', 'Bagus', 'Tri', '2020-12-30T03-31-37.346ZCapture.PNG', '1994-10-10', '082350775253', 'Balikpapan Asoy', '', 'MALE', 1, 'ON', '2020-12-30 03:27:53', '2020-12-30 03:31:56');
